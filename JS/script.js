...
var button_persoflorian = document.getElementsByClassName("button--persoflorian")[0];
...
button_persoflorian.onclick = function(){
	tangram.className=
		tangram.className.replace(/tangram--(\S*)/,'tangram--persoflorian');
};
